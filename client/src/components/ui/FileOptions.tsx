...
function FileOptions(selectedFile : {fileName: string, path: string, fileId: string} | null) {
  ...
  const createQuiz = () => {
    ...
    axios.post(`https://buddy-xe7e.onrender.com/api/files/create-quiz`, {fileName: selectedFile?.fileName || "", fileId: selectedFile?.fileId || "", path: selectedFile?.path || ""}, { withCredentials: true })
      .then((res) => {
  ...
  const generateSummary = () => {
    ...
    axios.post(`https://buddy-xe7e.onrender.com/api/files/generate-summary`, {fileName: selectedFile?.fileName || "", fileId: selectedFile?.fileId || "", path: selectedFile?.path || ""}, { withCredentials: true })
      .then((res) => {
        setLoading(false);
  ...
  const explainLikeIm5 = () => {
    ...
    axios.post(`https://buddy-xe7e.onrender.com/api/files/explain-like-im-5`, {fileName: selectedFile?.fileName || "", fileId: selectedFile?.fileId || "", path: selectedFile?.path || ""}, { withCredentials: true })
      .then((res) => {
        setLoading(false);
